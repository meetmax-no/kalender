...
window.TASK_TYPES = {
    ...
    'TRACK2': { label: 'S2-NewCustomers', icon: 'info', color: 'text-blue-600', bg: 'bg-blue-100', defaultTime: '12:00' },
    'TRACK3': { label: 'S3-OldContacts', icon: 'info', color: 'text-blue-600', bg: 'bg-blue-100', defaultTime: '12:00' },
