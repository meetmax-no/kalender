...
window.TASK_TYPES = {
    ...
    'TRACK3': { label: 'S3-OldContacts', icon: 'info', color: 'text-pink-600', bg: 'bg-pink-100', defaultTime: '12:00' },
    'TRACK4': { label: 'S4-TheContract', icon: 'info', color: 'text-pink-600', bg: 'bg-pink-100', defaultTime: '12:00' },
